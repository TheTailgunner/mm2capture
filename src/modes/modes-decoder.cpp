...
unsigned DecoderBackendBeast::getFrameLength(char byte) {
  switch (byte) {
  case 0x31:
...
unsigned DecoderBackendBeast::tryDecode(const QByteArray &data,
...
unsigned ModesDecoder::tryDecode(const QByteArray &data,
                                 QVector<ModesData> &outMsgs) {
